...
public partial class TravelExpertsContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer(
            "Data Source=localhost\\sqlexpress01;Initial Catalog=TravelExperts;Integrated Security=True;" +
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PackagesProductsSuppliersId).HasName("PK__Packages__E2B6EFA4BD05BBBE");
