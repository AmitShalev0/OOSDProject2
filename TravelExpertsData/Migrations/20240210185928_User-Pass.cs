    ...
    public partial class UserPass : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustUserName = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    CustPassword = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    CustConfirmPassword = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    ...
                    CustHomePhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PackagesProductsSuppliersId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PackageId = table.Column<int>(type: "int", nullable: false),
                    ProductSupplierId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Packages__E2B6EFA4BF4141F2", x => x.PackagesProductsSuppliersId);
                    table.ForeignKey(
                        name: "FK_Packages_Products_Suppliers_PackageId",
